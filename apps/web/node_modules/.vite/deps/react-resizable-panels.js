...
function Vt(e) {
  ...
  return Ye(e).forEach((c) => {
    ...
    t = false, q.set(
      ...
      Ge,
      true
    ), d.removeEventListener("pointerleave", $e), d.removeEventListener("pointermove", je), d.removeEventListener("pointerout", He), d.removeEventListener("pointerup", Ve, true)), s.disconnect();
  };
}
function Bt() {
...
var K = typeof window < "u" ? import_react.useLayoutEffect : import_react.useEffect;
function oe(e) {
...
var at = (0, import_react.createContext)(null);
function Wt(e, t) {
  const n = (0, import_react.useRef)({
    getLayout: () => ({}),
    setLayout: Nt
  });
  (0, import_react.useImperativeHandle)(t, () => n.current, []), K(() => {
    Object.assign(
      n.current,
      tt({ groupId: e })
    );
...
function Ut({
  ...
  }), m = we(r), S = (0, import_react.useRef)(null), [v, y] = Bt(), h = (0, import_react.useRef)({
  ...
  }), (0, import_jsx_runtime.jsx)(at.Provider, { value: X, children: (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...z,
      className: t,
...
function on({
  ...
  const i = t !== void 0, s = "id" in o ? o.id : o.groupId, l = de(s, t ?? []), r = (0, import_react.useSyncExternalStore)(
    Xt,
    () => n.getItem(l),
    () => n.getItem(l)
  ...
  }, [a, s, t, n]), f = a ?? u, g = (0, import_react.useRef)(null), d = (0, import_react.useCallback)(() => {
    const c = g.current;
  ...
  const z = (0, import_react.useCallback)(
    (c) => {
      d();
      let p;
...
function Ce() {
  const e = (0, import_react.useContext)(at);
  return L(
    e,
...
function qt(e, t) {
  const { id: n } = Ce(), o = (0, import_react.useRef)({
    collapse: me,
    expand: me,
    getSize: () => ({
      asPercentage: 0,
  ...
  (0, import_react.useImperativeHandle)(t, () => o.current, []), K(() => {
    Object.assign(
      o.current,
...
function Yt({
  ...
  const c = !!a, p = we(a), m = Le({
    disabled: s
  }), S = (0, import_react.useRef)(null), v = Pe(S, l), {
    getPanelStyles: y,
    id: h,
    orientation: P,
    registerPanel: M,
  ...
  }, w = (0, import_react.useSyncExternalStore)(
    (R) => ve(h, R),
    b,
    b
  );
  ...
  return w ? E = JSON.parse(w) : i ? E = {
    ...
    flexShrink: void 0,
    flexBasis: i
  } : E = { flexGrow: 1 }, (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...x,
...
function Qt({
  ...
  const r = we(i), a = Le({
    disabled: n
  }), [u, f] = (0, import_react.useState)({}), [g, d] = (0, import_react.useState)("inactive"), z = (0, import_react.useRef)(null), x = Pe(z, o), {
    disableCursor: c,
    id: p,
    orientation: m,
    registerSeparator: S,
  ...
  }, [p, r, S, a]), (0, import_react.useEffect)(() => {
    v(r, !!n);
  }, [n, r, v]);
  let h;
  return n && !c && (h = "not-allowed"), (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...l,
